...
class BackupService {
  ...
  List<ContentItem> decode(String raw) {
    ...
    try {
      ...
      throw FormatException(tr('backup.err.notJson'));
    }
    ...
    if (data is List) {
      ...
      throw FormatException(tr('backup.err.notBackup'));
    }
    ...
    try {
      ...
      throw FormatException(tr('backup.err.badFormat'));
    }
  }
  ...
  Future<String> exportAndShare(List<ContentItem> items) async {
    ...
    await SharePlus.instance.share(
      ShareParams(
        ...
        subject: tr('backup.share.subject'),
        text: tr('backup.share.text', {
  ...
  Future<BackupImport?> pickAndDecode() async {
    ...
    if (picked.bytes != null) {
      ...
      throw FormatException(tr('backup.err.cantReadFile'));
    }
